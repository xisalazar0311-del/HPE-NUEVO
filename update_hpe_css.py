...
html.light-theme .sidebar a {
  color: #1a202c !important; /* Más contraste negro para la sidebar */
...
html.light-theme .avatar-sm {
  ...
  color: #1a202c !important; /* Force high contrast for user initials */
  font-weight: 700 !important;
}
...
/* Invert hardcoded text colors over accent backgrounds */
html.light-theme .company-logo,
html.light-theme .chat-icon svg,
html.light-theme .send-btn {
  color: #ffffff !important;
}

/* Specific overrides for mobile header menu button */
